...
<body>
    ...
    $sql = "SELECT pro.nombre,pro.dni ,pro.fecha,Sum(it.tiempo_estimado)
            ...
            inner join TPBD_ESTADO est on est.id_estado=it.id_estado where proyectoTerminado(pro.id_proyecto)='Terminado'
            group by pro.nombre,pro.dni ,pro.fecha";
    ...
    print "<tr>\n
      ...
      <td> DURACIÓN DEL PROYECTO EN DIAS </td>\n
      </tr>\n";
